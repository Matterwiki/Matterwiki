...
// GEEZ: http://stackoverflow.com/a/37253642/1217785
...
// Importing all endpoints for assets
require("./api/assets")(apiRoutes);
...
// for the wiki assets
app.use('/wiki_assets', express.static("wiki_assets"));
