...
const { userHolder, tokenHolder } = require("../../testHelpers/modelHolder");
const { factories, apiClient } = require("../../testHelpers/testHelpers");
...
describe("Topic API Tests", () => {
  ...
  beforeEach(() =>
    Promise.all(factories.topic.build(2).map(topic => TopicModel.post(topic)))
  );

  describe("GET api/topics", () => {
    test("200 any - VALID - returns expected list", () =>
      apiClient
        .get(apiUrl)
